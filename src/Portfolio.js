    ...
    return (
        <div>
            ...
            <div id='welcome-section'>
                ...
                <h2 className='hover-2'>{"{Actualmente empleado en React}"}</h2>
            </div>
        </div>
    )
}
        ...
        <div className='container' id='quien-soy'>
            <div className='jumbotron' style={{lineHeight: "20px"}} >
                <div id='txt'>
                    ...
                    <br></br>
                    Me llamó la atención el <span className='hover-2'>valor</span> que podemos aportar mediante un código y un objetivo conjunto.
                    </p>
                    <br /><br />
                    <div id='pie-pagina'>
                    ...
                    <p className='rwd-line'>Actualmente <strike>busco un trabajo que permita seguir formándome y
                        abrirme a nuevas posibilidades</strike> estoy empleado en JavaScript y React :)
                    </p>
                    <br />
                    ...
                    <p className='rwd-line'>Contáctame vía gmail para cualquier duda, puesta a prueba o saludarme!
                    </p>
                </div>
            </div>
        </div>
    ...
    <>
        <div id='pie-pagina'>
            ...
            <div id='social-buttons'>
                <a href="https://twitter.com/debellodev" class="" rel="noopener noreferrer"><img className="RRSS" src="img/twitter-logo.png"alt="twitter handle" /></a>
                <a href="https://github.com/debello/" class="" rel="noopener noreferrer"><img className="RRSS" src="img/github-logo.png" alt="twitter handle" /></a>
            </div>
            <div id='mini-raya'></div>
